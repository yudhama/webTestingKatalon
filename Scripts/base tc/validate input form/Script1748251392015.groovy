...
WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Tokyo CURA Healthcare Center'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Medicare'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Medicare'), 'Medicare')

WebUI.doubleClick(findTestObject('Object Repository/Page_CURA Healthcare Service/p_testing comment'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/p_testing comment'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_testing comment'), 'testing comment')
